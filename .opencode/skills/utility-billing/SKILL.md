...
- A reading's category and account must be derived from its selected meter: subscriber meters use their linked customer, private-transformer meters use the transformer's owner, and public transformer/feeder meters carry no customer account. Reject mismatches server-side before review or billing.
