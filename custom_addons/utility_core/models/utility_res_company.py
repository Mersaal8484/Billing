    ...
    def _init_utility_company_defaults(self):
        ...
        for company in companies:
            ...
            if not company.opening_journal_id:
                ...
                if j_open and j_open.company_id.id in (False, company.id):
            ...
            if not company.sales_journal_id:
                ...
                if j_sale and j_sale.company_id.id in (False, company.id):
            ...
            if not company.electricity_income_account_id:
                ...
                if acc and acc.company_id.id in (False, company.id):
            ...
            if not company.electricity_product_id:
                ...
                if prod and prod.company_id.id in (False, company.id):
