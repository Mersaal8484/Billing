...
class ResConfigSettings(models.TransientModel):
    ...
    def _default_filesystem_storage_path(self):
        return os.path.join(config['data_dir'], 'utility-media')
    ...
    media_backend = fields.Selection([
       ...
       default='filesystem', required=True)
    ...
    filesystem_storage_path = fields.Char(
        ...
        default=_default_filesystem_storage_path)
    ...
    def _check_infrastructure_backend_config(self):
        for rec in self:
            ...
            if rec.media_backend == 'filesystem' and not (rec.filesystem_storage_path or self._default_filesystem_storage_path()):
