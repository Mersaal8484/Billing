...
- [OCA_ADDONS_EVALUATION_AND_ADOPTION_PLAN.md](OCA_ADDONS_EVALUATION_AND_ADOPTION_PLAN.md) — تقييم 37 إضافة OCA وخطة استخدامها ودمجها؛ مقترحات وليست إضافات مثبتة.
